...
// Wallet
    ...
    if (settings.contains("nAnonymizePhcAmount"))
        SoftSetArg("-anonymizeaxelamount", settings.value("nAnonymizePhcAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in axel.cpp during shotdown to also remove the window positions
