...
enum WalletFeature {
    FEATURE_BASE = 80001, // the earliest version new wallets supports

    FEATURE_LATEST = 80001
};
...
enum AvailableCoinsType {
    ...
    ONLY_NONDENOMINATED_NOTDEPOSITIFMN = 4, // ONLY_NONDENOMINATED and not deposit axel at the same time
