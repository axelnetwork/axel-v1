...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
        ...
        (49423, uint256("34ca978c09ed92db6ea875d3561fd9884fcf56067735242df6719fd7034a66fd"))
        (75125, uint256("450ac4fc0365aacca213415feae8050ff20442246282b9d438514a1faa45a549"))
        (80555, uint256("2b3729fa7c03fe4272355f1d8cb314f0183466eaea7337f09ca137d8b1ad1927"))
    ;
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("", "45.76.251.111"));    // TESTNET-AXEL-01   - Atlanta
        vSeeds.push_back(CDNSSeedData("", "108.61.155.190"));   // TESTNET-AXEL-02   - NYC
        vSeeds.push_back(CDNSSeedData("", "149.28.121.71"));    // TESTNET-AXEL-03   - Chicago
        vSeeds.push_back(CDNSSeedData("", "149.28.254.37"));    // TESTNET-AXEL-04   - Dallas
        vSeeds.push_back(CDNSSeedData("", "149.248.6.144"));    // TESTNET-AXEL-05   - LA
        vSeeds.push_back(CDNSSeedData("", "45.32.161.186"));    // TESTNET-AXEL-06   - Miami
        vSeeds.push_back(CDNSSeedData("", "144.202.86.193"));   // TESTNET-AXEL-07   - Seattle
