...
/** The maximum allowed number of signature check operations in a block (AXEL network rule) */
static const unsigned int AXEL_MAX_BLOCK_SIGOPS = AXEL_MAX_BLOCK_SIZE / 50;
/** Maximum number of signature check operations in an IsStandard() P2SH script */
static const unsigned int MAX_P2SH_SIGOPS = 15;
/** The maximum number of sigops we're willing to relay/mine in a single tx */
static const unsigned int MAX_TX_SIGOPS = MAX_BLOCK_SIGOPS / 5;
/** The maximum number of sigops we're willing to relay/mine in a single tx in AXEL network */
static const unsigned int AXEL_MAX_TX_SIGOPS = AXEL_MAX_BLOCK_SIGOPS / 5;
...
/** AXEL Masternode Rewards */
#define AXEL_D_MN_REWARDS_TIER1 0.08
#define AXEL_D_MN_REWARDS_TIER2 0.59
#define AXEL_D_MN_REWARDS_TIER3 0.13
